## 🙌 Profile
 아직은 경험보다 배움이 더 많지만 사용자에게 닿는 화면을 만들기 위해 **매일 코드를 쌓고 있습니다.**
...
| **프로젝트명** |  **설명**  | **기간** |
|------------|----------|--------|
| **SMP** | 2024.3~ 2024.6 | SMP는 사용자의 위치 기반으로 지역 정보를 공유하고 실시간 채팅을 통해 소통할 수 있는 커뮤니티 플랫폼 |
| **News Intelligent** | 2025.06~ 2025.09 | 클릭수와 체류시간을 기반으로 자극적인 뉴스가 추천되는 기존 뉴스플랫폼과 달리 같은 주제의 뉴스를 모으고 다양한 관점의 뉴스를 상위 노출하며, 정보를 통합 |
| **BAMBOO** | 2025.01~ 2026.01 | AI·데이터 동아리 내부 활동을 위한 자체 플랫폼 |
| **Deep-fake** | 2025.06.10~ 2026.06.26 | 종 생성모델 기반 하이브리드 데이터셋(ReGen-DF) 구축하며 GCP 환경에서 여러 생성 플랫폼의 API/토큰을 활용해 데이터를 수집·생성 |
| **oneday project** | 2026.02~ | AI 분야 논문 및 연구 트렌드 정보가 해외 위주로 분산된 문제를 해결, 개인 로드맵 포함한 웹 서비스 기획·개발  |
| **AccessGuard** | 2026.06~  | 팀원이 접근 권한을 신청하면, AI Agent가 사내 보안 정책을 검토하고 자동 승인/반려/에스컬레이션하는 시스템 |
...
| Bamboo 5기 운영진 | 2024.6~ 진행 중 |  DA,ML,DL에 이어 print review 커리큘럼 이수하고 운영진으로 캐글 대회 창작 
